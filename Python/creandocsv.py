...
try:
    open("documento.csv","x")
except:
    print ("ya existe")

escritura=open("documento.csv","w",newline="")
escritura_csv=csv.writer(escritura)
escritura_csv.writerow(["Rut","Nombre","Ventas"])
escritura_csv.writerows([
[72642413-6,"Comercial Calcetas Runner",150000000],
[76437473-2,"Reparacion Mac",300000000],
...
[76210124-2,"Buses Penalolen",150000000],
